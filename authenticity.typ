...
#let originality_statement() = [
  ...
  #text(font: ("Times New Roman", "Source Han Serif"), size: 11.7pt)[
    ...
    学生签名： #h(11em)日期：2024 年 05 月 15 日
  ]
]
...
#let copyright_authorization() = [
  ...
  #text(font: ("Times New Roman", "Source Han Serif"), size: 11.8pt)[
    ...
    #h(8em)2、不保密#box[#square(size: 0.7em)[#text(size: 15pt)[√]]]。

    #h(8em)（请在以上相应方框内打“√”）

    #box(height: 1em)

    #h(1em)学生签名： #h(10em)日期：2024 年 05 月 15 日

    #h(1em)导师签名： #h(10em)日期：2024 年 05 月 15 日
  ]
]
