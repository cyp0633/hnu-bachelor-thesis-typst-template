// 编写者注：在 GB/T 7714-2015 中，当引用英文文献时，“等”应为“et al.”。Typst 支持使用 CSL 定义参考文献格式，但不支持上述规则所需的 CSL-M 扩展规则。本文件是来自互联网的 workaround。
// 相关 Issue：https://github.com/typst/citationberg/issues/5
// 代码来自：https://typst.app/project/rN08qR13YfLociKdV7b1Mx
